...
**Source:** https://support.myclickfunnels.com/docs/getting-started-with-community
...
Navigate to the main menu on the left, click on + Add an App to navigate to the Apps page.
...
Open the Community app from your ClickFunnels dashboard then select Groups.
...
Adding Access Through the Members Section:

Go to Community and select Members.

Click New Membership at the top right.

Select an existing contact or create a new one.

Choose the Groups and Topics you want to grant access to.

(Optional) Enable the Community Moderator toggle if needed.

Click Create Membership to finalize.
...
Pin Important Topics and Posts
...
Recognizing and celebrating member achievements—whether it’s a milestone, success story, or valuable contribution—encourages further participation. You can highlight achievements through featured posts, shoutouts, or a dedicated “Member Spotlight” section.
